...
git push "https://$username:$password@github.com/carlosthe19916/keycloak-platform.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/carlosthe19916/keycloak-platform.git" --tags
